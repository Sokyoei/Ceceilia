...
# clang
set(CLANG_BASE_FLAGS "-fdiagnostics-color=always -Wall")
set(CLANG_CC_FLAGS "${CLANG_BASE_FLAGS}")
...
if(CMAKE_C_COMPILER_LOADED)
    if(CMAKE_C_COMPILER_ID STREQUAL "MSVC")
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${MSVC_CC_FLAGS}")
    elseif(CMAKE_C_COMPILER_ID STREQUAL "GNU")
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${GCC_CC_FLAGS}")
    elseif(CMAKE_C_COMPILER_ID STREQUAL "Clang")
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${CLANG_CC_FLAGS}")
    endif()
